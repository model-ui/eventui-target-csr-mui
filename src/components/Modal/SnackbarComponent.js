...
class SnackbarComponent extends Component {
  ...
  constructor(props) {
    ...
    this.events = props.manager.getEventManager().register(this.props.id, {
      show: {
        schema: {},
        handler: (obj) => {
  ...
  showSnackbar = (obj, open) => {
    ...
    if (open) {
      ...
      this.setState(state);
      this.props.manager.getEventManager().addEvent(this.props.id, this.events['showing'].id, { ...state }, null);
    } else {
      this.setState({ ...this.state, ...{ open: open } });
      this.props.manager.getEventManager().addEvent(this.props.id, this.events['closed'].id, { ...state }, null);
    }
  ...
  handleClose = (evt, reason) => {
    ...
    this.props.manager.getEventManager().addEvent(this.props.id, this.events['closing'].id, { ...this.state }, null);
