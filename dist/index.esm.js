import { structs, layout } from 'eventfull-core-runtime';
...
var events$i = structs.ListBase.events;
var triggers$i = structs.ListBase.triggers;
var config$i = {
  name: "Avatars",
  type: "avatars",
...
function AvatarRender(props) {
  ...
  if (items.length === 1) {
    return /*#__PURE__*/React.createElement(AvatarSingleRender, {
      name: items[0].id,
      key: items[0].id,
      data: items[0],
      config: props.config,
...
function Avatar(props) {
  ...
  return /*#__PURE__*/React.createElement(AvatarComponent$1, props);
}
...
var events$h = structs.ListBase.events;
var triggers$h = structs.ListBase.triggers;
var options$i = {
  "id": "buttons",
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "Buttons",
...
function ButtonRegular(props) {
  ...
  if (data.title) {
    ...
    return /*#__PURE__*/React.createElement(IconButton, {
      ...
      ,
      onClick: handleClick
    }, /*#__PURE__*/React.createElement(Icon, null, getIcon(data.icon)));
  }
}
...
var ButtonComponent = /*#__PURE__*/function (_structs$ListBase$Lis) {
  ...
  _createClass(ButtonComponent, [{
    ...
    value: function render() {
      ...
      if (items.length === 1) {
        var itm = items[0];
        content.push( /*#__PURE__*/React.createElement(ButtonSingle, {
          key: itm.id,
          data: itm,
          config: this.props.config,
        ...
        if (this.props.config.options.variant === 'fab') {
          ...
          items.map(function (itm) {
            return content.push( /*#__PURE__*/React.createElement(ButtonFab, {
              key: itm.id,
              data: itm,
          ...
          content.push( /*#__PURE__*/React.createElement(ButtonGroup, {
            key: this.props.id,
            variant: _options.x,
            ...
            if (itm.icon && !itm.title) {
              ...
              }, /*#__PURE__*/React.createElement(Icon, null, getIcon(itm.icon)));
            } else {
              return /*#__PURE__*/React.createElement(Button$1, {
                key: itm.id,
                variant: variant,
...
function Button(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React.createElement(ButtonComponent$1, props);
}
...
var events$g = structs.ListBase.events;
var triggers$g = structs.ListBase.triggers;
var options$h = {
  "id": "cards",
  "$schema": "http://json-schema.org/draft-07/schema#",
...
function CardComponentRender(card_id, item, classes, view, component_id) {
  ...
  if (item.title || item.actions) {
    content.push( /*#__PURE__*/React.createElement(CardComponentHeader, {
      id: id + "header",
      key: id + "header",
  ...
  if (item.media) {
    content.push( /*#__PURE__*/React.createElement(CardComponentMedia, {
      id: id + "media",
      key: id + "media",
...
function Card(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React.createElement(CardComponent$1, props);
}
...
var events$f = structs.ListBase.events;
var triggers$f = structs.ListBase.triggers;
var options$g = {
  "id": "images",
  "$schema": "http://json-schema.org/draft-07/schema#",
...
var ImageComponent$1 = withStyles(style$f, {
  withTheme: true
})(ImageComponent);

function Image(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React.createElement(ImageComponent$1, props);
} ////////////////////////////////////////////////
...
var events$e = structs.ListBase.events;
var triggers$e = structs.ListBase.triggers;
var options$f = {
  "id": "list",
  "$schema": "http://json-schema.org/draft-07/schema#",
...
function ListAvatar(props) {
  ...
  return (
    ...
    React.createElement(ListItemAvatar, null, /*#__PURE__*/React.createElement(AvatarRender, {
  ...
  function ListComponent() {
    ...
    return _possibleConstructorReturn(_this, (_this = _super.call.apply(_super, [this].concat(args)), _this.secondaryAction = function (itm, classes) {
      if (itm.secondary) {
        ...
        if (action) {
          return /*#__PURE__*/React.createElement(ListItemSecondaryAction, null, action);
        }
      }
  ...
  _createClass(ListComponent, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(List$1, {
        ...
        }, /*#__PURE__*/React.createElement(ListAvatar, {
          avatar: itm.avatar
...
var ListComponent$1 = withStyles(style$e, {
  withTheme: true
})(ListComponent);

var events$d = structs.ListBase.events;
var triggers$d = structs.ListBase.triggers;
var options$e = {
  "id": "dropdown",
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "Dropdown",
...
var DropdownComponent$1 = withStyles(style$d, {
  withTheme: true
})(DropdownComponent);

function List(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React.createElement(ListComponent$1, props);
}
function Dropdown(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React.createElement(DropdownComponent$1, props);
}
...
var events$c = structs.ListBase.events;
var triggers$c = structs.ListBase.triggers;
var options$d = {
  "id": "texts",
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "Texts",
...
var TextComponent = /*#__PURE__*/function (_structs$ListBase$Lis) {
  ...
  _createClass(TextComponent, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(React.Fragment, null, this.state.data.map(function (itm, idx) {
...
var TextComponent$1 = withStyles(style$c, {
  withTheme: true
})(TextComponent);
/*
const input_schema = {
...
function Text(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React.createElement(TextComponent$1, props);
} ////////////////////////////////////////////////
...
var events$b = structs.TreeBase.events;
var triggers$b = structs.TreeBase.triggers;
var options$c = {
  "id": "tree",
  "$schema": "http://json-schema.org/draft-07/schema#",
...
var TreeComponent$1 = withStyles(style$b, {
  withTheme: true
})(TreeComponent);

function Tree(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React.createElement(TreeComponent$1, props);
}
...
var events$a = structs.ListSchemaBase.events;
var triggers$a = structs.ListSchemaBase.triggers;
var options$b = {
  "id": "table",
  "$schema": "http://json-schema.org/draft-07/schema#",
...
var TableComponent = /*#__PURE__*/function (_structs$ListSchemaBa) {
  ...
  _createClass(TableComponent, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(TableContainer, null, /*#__PURE__*/React.createElement(Table$1, {
        className: classes.table,
        size: this.props.config.options.size
      }, /*#__PURE__*/React.createElement(TableHead, null, /*#__PURE__*/React.createElement(TableRow, null, columns.map(function (column, idx) {
        return /*#__PURE__*/React.createElement(TableCell, {
          key: column.id,
          align: column.align,
          style: {
      ...
      }))), /*#__PURE__*/React.createElement(TableBody, null, rows.map(function (row, row_index) {
...
}(structs.ListSchemaBase.ListSchemaBase);

var TableComponent$1 = withStyles(style$a, {
  withTheme: true
})(TableComponent);

var events$9 = structs.ListSchemaBase.events;
var triggers$9 = structs.ListSchemaBase.triggers;
var options$a = {
  "id": "datagrid",
  "$schema": "http://json-schema.org/draft-07/schema#",
...
var DataGridComponent = /*#__PURE__*/function (_structs$ListSchemaBa) {
  ...
  _createClass(DataGridComponent, [{
    ...
    value: function render() {
      ...
      }, /*#__PURE__*/React.createElement(DataGrid$1, {
...
var DataGridComponent$1 = withStyles(style$9, {
  withTheme: true
})(DataGridComponent);

function Table(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React.createElement(TableComponent$1, props);
}
...
function DataGrid(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React.createElement(DataGridComponent$1, props);
}
...
var events$8 = structs.InputBase.events;
var triggers$8 = structs.InputBase.triggers;
var options$9 = {
  "id": "textfield",
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "Textfield",
...
var TextfieldComponent$1 = withStyles(style$8, {
  withTheme: true
})(TextfieldComponent);

var events$7 = structs.ListBase.events;
var triggers$7 = structs.ListBase.triggers;
var options$8 = {
  "id": "checkboxes",
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "Checkboxes",
...
var CheckboxComponent = /*#__PURE__*/function (_structs$ListBase$Lis) {
  ...
  function CheckboxComponent() {
    ...
    return _possibleConstructorReturn(_this, (_this = _super.call.apply(_super, [this].concat(args)), _this.handleSelect = function (item, idx, evt) {
      ...
      if (helper_text) {
        return /*#__PURE__*/React.createElement(FormHelperText, null, helper_text);
      }
    }, _this.updateView = function (action, arr, updated, data) {
      // extend by parent
      if (action === 'select') {
  ...
  _createClass(CheckboxComponent, [{
    ...
    value: function render() {
      ...
      }, this.renderFormLabel(legend_text), /*#__PURE__*/React.createElement(FormGroup, {
        style: {
          justifyContent: 'center'
        },
...
var CheckboxComponent$1 = withStyles(style$7, {
  withTheme: true
})(CheckboxComponent);

function Textfield(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React.createElement(TextfieldComponent$1, props);
}
function Checkbox(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React.createElement(CheckboxComponent$1, props);
}
...
layout.LayoutBase.events;
layout.LayoutBase.triggers;
var options$7 = {
  "id": "container",
  "$schema": "http://json-schema.org/draft-07/schema#",
...
var events$6 = layout.LayoutBase.events;
var triggers$6 = layout.LayoutBase.triggers;
var options$6 = {
  "id": "tabs",
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "Tabs",
  ...
  _createClass(TabsComponent, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        }, state.selectedIndex === idx && /*#__PURE__*/React.createElement(Box, {
          p: config.options.contentMargin
        }, /*#__PURE__*/React.createElement("div", null, _this2.renderContent(classes, itm))));
      }));
    }
  }]);
...
var events$5 = layout.LayoutBase.events;
var triggers$5 = layout.LayoutBase.triggers;
var options$5 = {
  "id": "grid-columns",
  "$schema": "http://json-schema.org/draft-07/schema#",
  "description": "Grid",
...
var config$5 = {
  ...
  options: options$5,
  state: layout.LayoutBase.StateLayout // styles
...
var StateGrid = layout.LayoutBase.StateLayout;
...
var events$2 = layout.LayoutBase.events;
var triggers$2 = layout.LayoutBase.triggers;
var options$2 = {
  "id": "accordion",
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "Accordion",
  ...
  function AccordionComponent(props) {
    ...
    _this.renderTextDetails = function (classes, itm) {
      ...
      if (secondaryHeading) {
        ...
        }, itm.title), /*#__PURE__*/React.createElement(Typography, {
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        return (
          ...
          React.createElement(Accordion$1, {
            key: itm.id + idx,
            disabled: itm.disabled || false,
            ...
            id: "panel1a-header"
          }, _this2.renderTextDetails(classes, itm)), /*#__PURE__*/React.createElement(AccordionDetails, null, /*#__PURE__*/React.createElement("div", null, _this2.renderContent(classes, itm))))
        );
      }));
    }
  }]);
...
var events$1 = layout.LayoutBase.events;
var triggers$1 = layout.LayoutBase.triggers;
var options$1 = {
  "id": "layout",
  "$schema": "http://json-schema.org/draft-07/schema#",
    ...
    value: function render() {
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          if (item.type === 'layout') {
            content.push( /*#__PURE__*/React.createElement(layout.Layout.Layouter, {
              id: id,
              key: id,
              classes: classes,
              data: data,
...
var LayoutComponent$1 = withStyles(style, {
  withTheme: true
})(LayoutComponent);

var events = layout.LayoutBase.events;
var triggers = layout.LayoutBase.triggers;
var options = {
  "id": "view",
  "$schema": "http://json-schema.org/draft-07/schema#",
  "description": "View",
...
function View(props) {
  ...
  return /*#__PURE__*/React.createElement(ViewComponent, props);
}
function Layout(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React.createElement(LayoutComponent$1, props);
}
function Grid(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React.createElement(GridComponent$1, props);
}
function GridColumn(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React.createElement(GridColumnComponent$1, props);
}
function GridRow(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React.createElement(GridRowComponent$1, props);
}
function Accordion(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React.createElement(AccordionComponent$1, props);
}
function Tabs(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React.createElement(TabsComponent$1, props);
}
...
export { Layout, registerComponents };
