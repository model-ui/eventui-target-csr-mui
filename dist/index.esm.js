  ...
  _createClass(StateInstance, [{
    ...
    value: function alterState(change, skip_component_update) {
      ...
      if (_typeof(change) === 'object') {
        var changed = produce(this.state, function (draft) {
          _this.__updateObject(draft, change);
        });
        this.setState(changed, skip_component_update);
        return changed;
      } else {
        var _changed = produce(this.state, change);
...
function AvatarRender(props) {
  ...
  if (items.length === 1) {
    return /*#__PURE__*/React__default.createElement(AvatarSingleRender, {
      name: items[0].id,
      key: items[0].id,
      data: items[0],
      config: props.config,
    ...
    return /*#__PURE__*/React__default.createElement(AvatarGroup, {
...
var AvatarComponent$1 = withStyles(style$h, {
  withTheme: true
})(AvatarComponent);

function Avatar(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React__default.createElement(AvatarComponent$1, props);
}
...
function CardComponentMedia(props) {
  ...
  return /*#__PURE__*/React__default.createElement(CardMedia, {
...
function CardComponentActions(action_content) {
  ...
  return /*#__PURE__*/React__default.createElement(CardActions, {
    disableSpacing: true
  }, actions);
}
...
function CardComponentRender(card_id, item, classes, view, component_id) {
  ...
  if (item.title || item.actions) {
    content.push( /*#__PURE__*/React__default.createElement(CardComponentHeader, {
      id: id + "header",
      key: id + "header",
  ...
  if (item.media) {
    content.push( /*#__PURE__*/React__default.createElement(CardComponentMedia, {
      id: id + "media",
      key: id + "media",
...
var CardComponent$1 = withStyles(style$g, {
  withTheme: true
})(CardComponent);

function Card(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React__default.createElement(CardComponent$1, props);
}
...
function ListAvatar(props) {
  ...
  return (
    ...
    React__default.createElement(ListItemAvatar, null, /*#__PURE__*/React__default.createElement(AvatarRender, {
  ...
  function ListComponent() {
    ...
    return _possibleConstructorReturn(_this, (_this = _super.call.apply(_super, [this].concat(args)), _this.secondaryAction = function (itm, classes) {
      if (itm.secondary) {
        ...
        if (action) {
          return /*#__PURE__*/React__default.createElement(ListItemSecondaryAction, null, action);
        }
      }
  ...
  _createClass(ListComponent, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement(List$1, {
        ...
        }, /*#__PURE__*/React__default.createElement(ListAvatar, {
          avatar: itm.avatar
...
var ListComponent$1 = withStyles(style$f, {
  withTheme: true
})(ListComponent);
...
var DropdownComponent$1 = withStyles(style$e, {
  withTheme: true
})(DropdownComponent);

function List(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React__default.createElement(ListComponent$1, props);
}
function Dropdown(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React__default.createElement(DropdownComponent$1, props);
}
...
var TableComponent = /*#__PURE__*/function (_ListSchemaBase) {
  ...
  _createClass(TableComponent, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement(TableContainer, null, /*#__PURE__*/React__default.createElement(Table$1, {
        className: classes.table,
        size: this.props.config.options.size
      }, /*#__PURE__*/React__default.createElement(TableHead, null, /*#__PURE__*/React__default.createElement(TableRow, null, columns.map(function (column, idx) {
        return /*#__PURE__*/React__default.createElement(TableCell, {
          key: column.id,
          align: column.align,
          style: {
      ...
      }))), /*#__PURE__*/React__default.createElement(TableBody, null, rows.map(function (row, row_index) {
...
var TableComponent$1 = withStyles(style$d, {
  withTheme: true
})(TableComponent);
...
var DataGridComponent = /*#__PURE__*/function (_ListSchemaBase) {
  ...
  _createClass(DataGridComponent, [{
    ...
    value: function render() {
      ...
      }, /*#__PURE__*/React__default.createElement(DataGrid$1, {
...
var DataGridComponent$1 = withStyles(style$c, {
  withTheme: true
})(DataGridComponent);

function Table(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React__default.createElement(TableComponent$1, props);
}
...
function DataGrid(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React__default.createElement(DataGridComponent$1, props);
}
...
var TextComponent = /*#__PURE__*/function (_ListBase) {
  ...
  _createClass(TextComponent, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, this.state.data.map(function (itm, idx) {
...
var TextComponent$1 = withStyles(style$b, {
  withTheme: true
})(TextComponent);
/*
const input_schema = {
...
function Text(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React__default.createElement(TextComponent$1, props);
} ////////////////////////////////////////////////
...
var ImageComponent = /*#__PURE__*/function (_ListBase) {
  ...
  _createClass(ImageComponent, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement("div", {
        className: classes.root
      }, /*#__PURE__*/React__default.createElement(ImageList, {
        rowHeight: 360,
        className: classes.imageList,
        cols: 3
      }, this.state.data.map(function (item) {
        return /*#__PURE__*/React__default.createElement(ImageListItem, {
          key: item.url,
          cols: item.cols || 1
...
var ImageComponent$1 = withStyles(style$a, {
  withTheme: true
})(ImageComponent);

function Image(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React__default.createElement(ImageComponent$1, props);
} ////////////////////////////////////////////////
...
var TextfieldComponent$1 = withStyles(style$9, {
  withTheme: true
})(TextfieldComponent);
...
var CheckboxComponent = /*#__PURE__*/function (_ListBase) {
  ...
  function CheckboxComponent() {
    ...
    return _possibleConstructorReturn(_this, (_this = _super.call.apply(_super, [this].concat(args)), _this.handleSelect = function (item, idx, evt) {
      ...
      if (legend_text) {
        return /*#__PURE__*/React__default.createElement(FormLabel, {
          component: "legend"
        }, legend_text);
      }
    }, _this.renderFormHelperText = function (helper_text) {
      if (helper_text) {
        return /*#__PURE__*/React__default.createElement(FormHelperText, null, helper_text);
      }
    }, _this.updateView = function (action, arr, updated, data) {
      // extend by parent
      if (action === 'select') {
  ...
  _createClass(CheckboxComponent, [{
    ...
    value: function render() {
      ...
      }, this.renderFormLabel(legend_text), /*#__PURE__*/React__default.createElement(FormGroup, {
        style: {
          justifyContent: 'center'
        },
...
var CheckboxComponent$1 = withStyles(style$8, {
  withTheme: true
})(CheckboxComponent);

function Textfield(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React__default.createElement(TextfieldComponent$1, props);
}
function Checkbox(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React__default.createElement(CheckboxComponent$1, props);
}
...
var DialogTitleClosable = withStyles(modalStyles)(function (props) {
  var children = props.children,
      classes = props.classes,
      onClose = props.onClose,
      other = _objectWithoutProperties(props, _excluded);

  return /*#__PURE__*/React__default.createElement(MuiDialogTitle, _extends({
    disableTypography: true,
    className: classes.root
  }, other), /*#__PURE__*/React__default.createElement(Typography, {
    variant: "h6"
  }, children), onClose ? /*#__PURE__*/React__default.createElement(IconButton, {
    "aria-label": "close",
...
function DialogRender(id, data, classes, config_render, open, setOpen, modal_body) {
  ...
  if (config_render.options.modalType === 'modal') {
    ...
    }, /*#__PURE__*/React__default.createElement(MuiDialogTitle, null, data.title), /*#__PURE__*/React__default.createElement(DialogContent, null, modal_body), /*#__PURE__*/React__default.createElement(DialogActions, null, /*#__PURE__*/React__default.createElement(Button$1, {
      onClick: handleDone,
      color: "primary",
      autoFocus: true
    }, data.label)));
    ...
    return /*#__PURE__*/React__default.createElement(Dialog$1, {
      ...
      "aria-labelledby": "form-dialog-title",
      "aria-describedby": "form-dialog-description"
    }, /*#__PURE__*/React__default.createElement(_DialogTitle, null, data.title), /*#__PURE__*/React__default.createElement(DialogContent, null, /*#__PURE__*/React__default.createElement(DialogContentText, {
      id: "alert-dialog-description"
    }, data.description), modal_body), /*#__PURE__*/React__default.createElement(DialogActions, null, /*#__PURE__*/React__default.createElement(Button$1, {
    ...
    return /*#__PURE__*/React__default.createElement(Dialog$1, {
      ...
      "aria-labelledby": "form-dialog-title",
      "aria-describedby": "form-dialog-description"
    }, /*#__PURE__*/React__default.createElement(_DialogTitle2, null, data.title), /*#__PURE__*/React__default.createElement(DialogContent, null, /*#__PURE__*/React__default.createElement(DialogContentText, {
      id: "alert-dialog-description"
    }, data.description), modal_body), /*#__PURE__*/React__default.createElement(DialogActions, null, /*#__PURE__*/React__default.createElement(Button$1, {
      onClick: function onClick() {
        handleClose({
      ...
      color: "secondary"
    }, config_render.options.labelCancel), /*#__PURE__*/React__default.createElement(Button$1, {
      onClick: function onClick() {
        handleClose({
          'confirm': true
        });
    ...
    }, /*#__PURE__*/React__default.createElement(_DialogTitle3, {
      id: "alert-dialog-title"
    }, data.title), /*#__PURE__*/React__default.createElement(DialogContent, null, /*#__PURE__*/React__default.createElement(DialogContentText, {
      id: "alert-dialog-description"
    }, data.description), modal_body), /*#__PURE__*/React__default.createElement(DialogActions, null, /*#__PURE__*/React__default.createElement(Button$1, {
      onClick: handleClose,
      color: "primary",
...
var SnackbarComponent = /*#__PURE__*/function (_Component) {
  ...
  _createClass(SnackbarComponent, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(Snackbar, {
        key: key,
...
var SnackbarComponent$1 = withStyles(style$7, {
  withTheme: true
})(SnackbarComponent);
...
function Dialog(props) {
  ...
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React__default.createElement(DialogComponent, props);
}
function PopupToaster(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React__default.createElement(SnackbarComponent$1, props);
}
...
var ContainerComponent$1 = withStyles(style$6, {
  withTheme: true
})(ContainerComponent);
  ...
  _createClass(TabsComponent, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement("div", {
        ...
        }, state.selectedIndex === idx && /*#__PURE__*/React__default.createElement(Box, {
          p: config.options.contentMargin
        }, /*#__PURE__*/React__default.createElement("div", null, _this2.renderContent(classes, itm))));
      }));
    }
  }]);
...
var TabsComponent$1 = withStyles(style$5, {
  withTheme: true
})(TabsComponent);
...
var GridComponent$1 = withStyles(style$4, {
  withTheme: true
})(GridComponent);
...
var GridRowComponent$1 = withStyles(style$3, {
  withTheme: true
})(GridRowComponent);
...
var GridColumnComponent$1 = withStyles(style$2, {
  withTheme: true
})(GridColumnComponent);
  ...
  function AccordionComponent(props) {
    ...
    _this.renderTextDetails = function (classes, itm) {
      ...
      if (secondaryHeading) {
        ...
        }, itm.title), /*#__PURE__*/React__default.createElement(Typography, {
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement("div", {
        ...
        return (
          ...
          React__default.createElement(Accordion$1, {
            key: itm.id + idx,
            disabled: itm.disabled || false,
            ...
            id: "panel1a-header"
          }, _this2.renderTextDetails(classes, itm)), /*#__PURE__*/React__default.createElement(AccordionDetails, null, /*#__PURE__*/React__default.createElement("div", null, _this2.renderContent(classes, itm))))
        );
      }));
    }
  }]);
...
var AccordionComponent$1 = withStyles(style$1, {
  withTheme: true
})(AccordionComponent);
...
function LayoutRender(container_id, data, classes, config) {
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      if (item.type === 'layout') {
        content.push( /*#__PURE__*/React__default.createElement(Layouter, {
          id: id,
          key: id,
          classes: classes,
          data: data,
...
function View(props) {
  ...
  return /*#__PURE__*/React__default.createElement(ViewComponent, props);
}
function Layout(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React__default.createElement(LayoutComponent, props);
}
function Container(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React__default.createElement(ContainerComponent$1, props);
}
function Grid(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React__default.createElement(GridComponent$1, props);
}
function GridColumn(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React__default.createElement(GridColumnComponent$1, props);
}
function GridRow(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React__default.createElement(GridRowComponent$1, props);
}
function Accordion(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React__default.createElement(AccordionComponent$1, props);
}
function Tabs(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React__default.createElement(TabsComponent$1, props);
}
...
function ButtonRegular(props) {
  ...
  if (data.title) {
    ...
    return /*#__PURE__*/React__default.createElement(IconButton, {
      ...
      ,
      onClick: handleClick
    }, /*#__PURE__*/React__default.createElement(Icon, null, getIcon(data.icon)));
  }
}
...
function ButtonFab(props) {
  ...
  return /*#__PURE__*/React__default.createElement(Fab, {
    key: data.id,
    variant: variant,
    color: data.color || options.color,
    disabled: data.disabled || false,
...
var ButtonComponent = /*#__PURE__*/function (_ListBase) {
  ...
  _createClass(ButtonComponent, [{
    ...
    value: function render() {
      ...
      if (items.length === 1) {
        var itm = items[0];
        content.push( /*#__PURE__*/React__default.createElement(ButtonSingle, {
          key: itm.id,
          data: itm,
          config: this.props.config,
        ...
        if (this.props.config.options.variant === 'fab') {
          ...
          items.map(function (itm) {
            return content.push( /*#__PURE__*/React__default.createElement(ButtonFab, {
              key: itm.id,
              data: itm,
          ...
          content.push( /*#__PURE__*/React__default.createElement(ButtonGroup, {
            key: this.props.id,
            variant: _options.x,
            ...
            if (itm.icon && !itm.title) {
              ...
              }, /*#__PURE__*/React__default.createElement(Icon, null, getIcon(itm.icon)));
            } else {
              return /*#__PURE__*/React__default.createElement(Button$1, {
                key: itm.id,
                variant: variant,
...
var ButtonComponent$1 = withStyles(useStyles, {
  withTheme: true
})(ButtonComponent);

function Button(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React__default.createElement(ButtonComponent$1, props);
}
...
var TreeComponent = /*#__PURE__*/function (_TreeBase) {
  ...
  _createClass(TreeComponent, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement(TreeView, {
...
var TreeComponent$1 = withStyles(style, {
  withTheme: true
})(TreeComponent);

function Tree(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React__default.createElement(TreeComponent$1, props);
}
...
function World() {
  return /*#__PURE__*/React.createElement(Stack, {
    ...
    variant: "text"
  }, "Text"), /*#__PURE__*/React.createElement(Button$1, {
    variant: "contained"
  }, "Contained"), /*#__PURE__*/React.createElement(Button$1, {
    variant: "outlined"
  }, "Outlined"));
}

export { Dialog, Layout, World, registerComponents };
